...
//Skeleton(150*150px): Idle (4), Attack (8), Shield (4), Take Hit (4), Death (4)
...
public class SkeletonAni extends BaseAnimationSprite{
    ...
    public SkeletonAni() {
    	super();
    	// 参数顺序：ImageView, 持续时间, 总帧数, 单帧宽, 单帧高
    ...
    public void playIdle() {
    	this.imageView.setImage(new Image("file:assets/Skeleton/Idle.png"));
    	playAnimation(this.idleAnim, ModelAnimation.INDEFINITE);
    }
    
    @Override 
    public void playAttack() {
    	this.imageView.setImage(new Image("file:assets/Skeleton/Attack.png"));
    	playAnimation(this.attackAnim, 1);
    }
    
    @Override
    public void playHurt() {
    	this.imageView.setImage(new Image("file:assets/Skeleton/Take Hit.png"));
    	playAnimation(this.hurtAnim, 1);
    }
    
    @Override
    public void playDeath() {
    	this.imageView.setImage(new Image("file:assets/Skeleton/Death.png"));
    	playAnimation(this.deathAnim,1);
    }
    
    public void playShield() {
    	this.imageView.setImage(new Image("file:assets/Skeleton/Shield.png"));
    	playAnimation(this.shieldAnim, 1);
    }
